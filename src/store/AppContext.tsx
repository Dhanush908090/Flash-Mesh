...
type Action =
  ...
  | { type: 'SET_CLIPBOARD'; items: FileEntry[]; operation: 'copy' | 'cut' }
  ...
  | { type: 'SET_VIEW'; view: 'files' | 'cloud' | 'pet' }
...
function reducer(state: AppState, action: Action): AppState {
  ...
  switch (action.type) {
    ...
    case 'SET_CLIPBOARD':
      return { ...state, clipboard: { items: action.items, operation: action.operation } };
